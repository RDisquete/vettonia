  ...
  return (
    <div ref={ref} className="relative overflow-hidden border-[3px] border-violeta"
      ...
      <div className="aspect-9/16 relative bg-violeta/95">
        ...
        <SolidTri className="w-6 h-6 left-[5%] top-[6%] z-30 rotate-60" style={{ backgroundColor: 'rgba(212,163,115,0.4)' }} />
        ...
        <SolidBox className="w-4 h-4 left-[28%] top-[30%] z-30 rotate-40" style={{ backgroundColor: 'rgba(255,255,255,0.1)' }} />
