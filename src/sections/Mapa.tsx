...
export default function Mapa() {
  return (
    <section id="mapa" className="px-5 py-24 relative overflow-hidden scroll-mt-24 min-h-[60vh] flex items-center ">
      ...
      <div className="absolute w-[50vw] h-[50vw] sm:w-[40vw] sm:h-[40vw] rounded-full border border-violeta/15 left-[60%] top-[50%] -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute w-[35vw] h-[35vw] sm:w-[28vw] sm:h-[28vw] rounded-full border border-dashed border-violeta/10 left-[60%] top-[50%] -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute w-[20vw] h-[20vw] sm:w-[16vw] sm:h-[16vw] rounded-full border border-violeta/20 left-[60%] top-[50%] -translate-x-1/2 -translate-y-1/2" />

      <SolidBox className="w-12 h-12 bg-coral/55 left-[20%] top-[6%] z-30 rotate-20" />
      <SolidRing className="w-24 h-24 border-violeta/30 left-[55%] top-[5%] z-30" />
      <SolidDot className="w-8 h-8 bg-coral/60 right-[8%] top-[30%] z-30" />
      <SolidBox className="w-10 h-10 bg-violeta/40 right-[35%] bottom-[25%] z-30 rotate-40" />
      <SolidRing className="w-20 h-20 border-coral/40 right-[3%] bottom-[15%] z-30" />
      <SolidDot className="w-6 h-6 bg-coral/55 left-[10%] bottom-[18%] z-30" />
      <SolidLine className="w-36 h-1 bg-violeta/30 right-[20%] top-[55%] z-30" />
      <SolidDot className="w-4 h-4 bg-coral/65 left-[45%] top-[55%] z-30" />
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-10 lg:gap-16 items-center max-w-6xl mx-auto">
          ...
          <div className="order-1 lg:order-2 relative shrink-0 mx-auto lg:mx-0">
            <div className="relative">
              <div className="w-28 h-28 sm:w-36 sm:h-36 rounded-full bg-coral/20 border-2 border-coral/50 flex items-center justify-center backdrop-blur-[2px]">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-coral" />
              </div>
              <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-0 h-0 border-l-14 border-r-14 border-t-16 border-l-transparent border-r-transparent border-t-coral/40" />
            </div>
            <div className="absolute top-[-20%] right-[-30%] w-16 h-16 sm:w-20 sm:h-20 border-2 border-dashed border-violeta/30 rounded-full" />
            <div className="absolute bottom-[10%] left-[-40%] w-12 h-12 border border-violeta/20 rounded-full" />
          </div>
        </div>
        </Reveal>
    </section>
